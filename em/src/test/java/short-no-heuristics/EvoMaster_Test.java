...
/**
 * This file was automatically generated by EvoMaster on 2024-02-06T20:20:11.184-03:00[America/Argentina/Buenos_Aires]
 * <br>
    ...
    */
    ...
    public void test_1() throws Exception {
        ...
        given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/employees?EMextraParam123=_EM_4_XYZ_")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_4() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .contentType("application/json")
                .body(" { " + 
                    " \"emailId\": \"DswWIqgZ919Y\", " + 
                    " \"firstName\": \"_EM_17_XYZ_\", " + 
                    " \"id\": 293, " + 
                    " \"lastName\": \"_EM_18_XYZ_\" " + 
                    " } ")
                ...
                .body("'lastName'", containsString("_EM_18_XYZ_"))
                .body("'emailId'", containsString("DswWIqgZ919Y"));
        location_employees = "/employees" + "/" + res_0.extract().body().path("id").toString();
        
        
        given().accept("*/*")
                .header("x-EMextraHeader123", "42")
                .get(resolveLocation(location_employees, baseUrlOfSut + "/employees/293"))
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_5() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .body(" { " + 
                    " \"emailId\": \"_EM_81_XYZ_\", " + 
                    " \"firstName\": \"_EM_82_XYZ_\", " + 
                    " \"id\": 438, " + 
                    " \"lastName\": \"_EM_83_XYZ_\" " + 
                    " } ")
                .post(baseUrlOfSut + "/employees")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                .body("'firstName'", containsString("_EM_82_XYZ_"))
                .body("'lastName'", containsString("_EM_83_XYZ_"))
                .body("'emailId'", containsString("_EM_81_XYZ_"));
        location_employees = "/employees" + "/" + res_0.extract().body().path("id").toString();
        
        
        ValidatableResponse res_1 = given().accept("*/*")
                .header("x-EMextraHeader123", "42")
                .delete(resolveLocation(location_employees, baseUrlOfSut + "/employees/438"))
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_6() throws Exception {
        ...
        given().accept("*/*")
                ...
                .contentType("application/json")
                .body(" { " + 
                    " \"firstName\": \"_EM_23_XYZ_\", " + 
                    " \"id\": 952 " + 
                    " } ")
                .put(resolveLocation(location_employees, baseUrlOfSut + "/employees/952?EMextraParam123=42"))
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                .body("'firstName'", containsString("_EM_23_XYZ_"))
                .body("'lastName'", nullValue())
                .body("'emailId'", nullValue());
    ...
    public void test_7() throws Exception {
        ...
        given().accept("*/*")
                ...
                .get(baseUrlOfSut + "/employees/704?EMextraParam123=_EM_0_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
    ...
    public void test_8() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .delete(baseUrlOfSut + "/employees/409?EMextraParam123=_EM_2_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("text/html");
    ...
    public void test_9() throws Exception {
        ...
        given().accept("*/*")
                ...
                .body(" { " + 
                    ...
                    " } ")
                .put(baseUrlOfSut + "/employees/820?EMextraParam123=_EM_15_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("text/html");
