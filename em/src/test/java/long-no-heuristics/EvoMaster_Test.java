...
/**
 * This file was automatically generated by EvoMaster on 2024-02-07T05:42:39.626-03:00[America/Argentina/Buenos_Aires]
 * <br>
    ...
    */
    ...
    public void test_0() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .body("'paths'.'/error'.'get'.'summary'", containsString("error"))
                .body("'paths'.'/error'.'get'.'operationId'", containsString("errorUsingGET"))
                .body("'paths'.'/error'.'get'.'produces'.size()", equalTo(1))
                .body("'paths'.'/error'.'get'.'produces'", hasItems("*/*"))
                .body("'paths'.'/error'.'get'.'responses'.'200'.'description'", containsString("OK"))
                .body("'paths'.'/error'.'get'.'responses'.'200'.'schema'.'type'", containsString("object"))
                .body("'paths'.'/error'.'get'.'responses'.'200'.'schema'.'additionalProperties'.'type'", containsString("object"))
                ...
                .body("'paths'.'/error'.'head'.'summary'", containsString("error"))
                .body("'paths'.'/error'.'head'.'operationId'", containsString("errorUsingHEAD"))
                ...
                .body("'paths'.'/error'.'head'.'produces'", hasItems("*/*"))
                .body("'paths'.'/error'.'head'.'responses'.'200'.'description'", containsString("OK"))
                .body("'paths'.'/error'.'head'.'responses'.'200'.'schema'.'type'", containsString("object"))
                .body("'paths'.'/error'.'head'.'responses'.'200'.'schema'.'additionalProperties'.'type'", containsString("object"))
                ...
                .body("'paths'.'/error'.'post'.'summary'", containsString("error"))
                .body("'paths'.'/error'.'post'.'operationId'", containsString("errorUsingPOST"))
                ...
                .body("'paths'.'/error'.'post'.'produces'", hasItems("*/*"))
                .body("'paths'.'/error'.'post'.'responses'.'200'.'description'", containsString("OK"))
                .body("'paths'.'/error'.'post'.'responses'.'200'.'schema'.'type'", containsString("object"))
                .body("'paths'.'/error'.'post'.'responses'.'200'.'schema'.'additionalProperties'.'type'", containsString("object"))
                ...
                .body("'paths'.'/error'.'put'.'summary'", containsString("error"))
                .body("'paths'.'/error'.'put'.'operationId'", containsString("errorUsingPUT"))
                ...
                .body("'paths'.'/error'.'put'.'produces'", hasItems("*/*"))
                .body("'paths'.'/error'.'put'.'responses'.'200'.'description'", containsString("OK"))
                .body("'paths'.'/error'.'put'.'responses'.'200'.'schema'.'type'", containsString("object"))
                .body("'paths'.'/error'.'put'.'responses'.'200'.'schema'.'additionalProperties'.'type'", containsString("object"))
                ...
                .body("'paths'.'/error'.'delete'.'summary'", containsString("error"))
                .body("'paths'.'/error'.'delete'.'operationId'", containsString("errorUsingDELETE"))
                .body("'paths'.'/error'.'delete'.'produces'.size()", equalTo(1))
                .body("'paths'.'/error'.'delete'.'produces'", hasItems("*/*"))
                .body("'paths'.'/error'.'delete'.'responses'.'200'.'description'", containsString("OK"))
                .body("'paths'.'/error'.'delete'.'responses'.'200'.'schema'.'type'", containsString("object"))
                .body("'paths'.'/error'.'delete'.'responses'.'200'.'schema'.'additionalProperties'.'type'", containsString("object"))
                ...
                .body("'paths'.'/error'.'options'.'summary'", containsString("error"))
                .body("'paths'.'/error'.'options'.'operationId'", containsString("errorUsingOPTIONS"))
                ...
                .body("'paths'.'/error'.'options'.'produces'", hasItems("*/*"))
                .body("'paths'.'/error'.'options'.'responses'.'200'.'description'", containsString("OK"))
                .body("'paths'.'/error'.'options'.'responses'.'200'.'schema'.'type'", containsString("object"))
                .body("'paths'.'/error'.'options'.'responses'.'200'.'schema'.'additionalProperties'.'type'", containsString("object"))
                ...
                .body("'paths'.'/error'.'patch'.'summary'", containsString("error"))
                .body("'paths'.'/error'.'patch'.'operationId'", containsString("errorUsingPATCH"))
                ...
                .body("'paths'.'/error'.'patch'.'produces'", hasItems("*/*"))
                .body("'paths'.'/error'.'patch'.'responses'.'200'.'description'", containsString("OK"))
                .body("'paths'.'/error'.'patch'.'responses'.'200'.'schema'.'type'", containsString("object"))
                .body("'paths'.'/error'.'patch'.'responses'.'200'.'schema'.'additionalProperties'.'type'", containsString("object"))
    ...
    public void test_2() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .delete(baseUrlOfSut + "/employees?EMextraParam123=_EM_6_XYZ_")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_3() throws Exception {
        ...
        given().accept("*/*")
                ...
                .body(" { " + 
                    " \"emailId\": \"_EM_8_XYZ_\", " + 
                    " \"firstName\": \"_EM_9_XYZ_\", " + 
                    " \"lastName\": \"AeCjlluZCMn01QU\" " + 
                    " } ")
                .post(baseUrlOfSut + "/employees?EMextraParam123=_EM_10_XYZ_")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                .body("'firstName'", containsString("_EM_9_XYZ_"))
                .body("'lastName'", containsString("AeCjlluZCMn01QU"))
                .body("'emailId'", containsString("_EM_8_XYZ_"));
    ...
    public void test_4() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .assertThat()
                .contentType("application/json")
                .body("'firstName'", containsString("ICkJk2X"))
                .body("'lastName'", containsString("NjLhBGW"))
                .body("'emailId'", containsString("_EM_46_XYZ_"));
        location_employees = "/employees" + "/" + res_0.extract().body().path("id").toString();
        
        
        given().accept("*/*")
                .header("x-EMextraHeader123", "42")
                .get(resolveLocation(location_employees, baseUrlOfSut + "/employees/995"))
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_5() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .assertThat()
                .contentType("application/json")
                .body("'firstName'", containsString("_EM_26_XYZ_"))
                .body("'lastName'", nullValue())
                .body("'emailId'", containsString("_EM_25_XYZ_"));
        location_employees = "/employees" + "/" + res_0.extract().body().path("id").toString();
        
        
        ValidatableResponse res_1 = given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .delete(resolveLocation(location_employees, baseUrlOfSut + "/employees/109"))
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_6() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .assertThat()
                .contentType("application/json")
                .body("'firstName'", containsString("_EM_60_XYZ_"))
                .body("'lastName'", nullValue())
                .body("'emailId'", containsString("_EM_19_XYZ_"));
        location_employees = "/employees" + "/" + res_0.extract().body().path("id").toString();
        ...
        given().accept("*/*")
                ...
                .body(" { " + 
                    ...
                    " \"id\": -679042702 " + 
                    " } ")
                .put(resolveLocation(location_employees, baseUrlOfSut + "/employees/-679042710"))
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                ...
                .body("'lastName'", nullValue())
                .body("'emailId'", containsString("_EM_22_XYZ_"));
    ...
    public void test_7() throws Exception {
        ...
        given().accept("*/*")
                .header("x-EMextraHeader123", "")
                .get(baseUrlOfSut + "/employees/2186842484226959461")
                .then()
                .statusCode(404)
                .assertThat()
    ...
    public void test_8() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .delete(baseUrlOfSut + "/employees/-42278001?EMextraParam123=_EM_2_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("text/html");
    ...
    public void test_9() throws Exception {
        ...
        given().accept("*/*")
                ...
                .body(" { " + 
                    " \"emailId\": \"_EM_12_XYZ_\", " + 
                    " \"lastName\": \"_EM_14_XYZ_\" " + 
                    " } ")
                .put(baseUrlOfSut + "/employees/757?EMextraParam123=_EM_15_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("text/html");
