...
/**
 * This file was automatically generated by EvoMaster on 2024-02-10T08:52:52.199-03:00[America/Argentina/Buenos_Aires]
 * <br>
    ...
    */
    ...
    public void test_8() throws Exception {
        ...
        ValidatableResponse res_0 = given().accept("*/*")
                ...
                .delete(baseUrlOfSut + "/employees/954?EMextraParam123=_EM_1_XYZ_")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("text/html");
    ...
    public void test_9() throws Exception {
        ...
        given().accept("*/*")
                ...
                .contentType("application/json")
                .body(" { " + 
                    " \"firstName\": \"_EM_11_XYZ_\" " + 
                    " } ")
                .put(baseUrlOfSut + "/employees/758")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("text/html");
